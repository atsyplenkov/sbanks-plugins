...
class SbanksAlgorithm(QgsProcessingAlgorithm):
    ...
    and Polygon geometries (including MULTILINESTRING and MULTIPOLYGONS).
    It includes anti-hook logic for LineStrings and proper wrapping for
    closed geometries. Optionally, spline-based resampling can be applied
    after smoothing following recommendations from Sylvester et al. (2021).

    Sylvester, Z., Durkin, P. R., Hubbard, S. M. & Mohrig, D. Autogenic
    translation and counter point bar deposition in meandering rivers. GSA
    Bulletin 133, 2439–2456 (2021).
    """
    ...
    def _smooth_linestring(
        ...
        """
        Smooth a LINESTRING geometry using S-G filter.
        """
    ...
    def _smooth_polygon(
        ...
        """
        Smooth a (MULTI)POLYGON geometry using S-G filter.
        """
    ...
    def _smooth_ring(
        ...
        """
        Smooth a polygon ring (closed curve) using S-G filter.
        """
    ...
    def shortHelpString(self):
        ...
        return self.tr(
            ...
            "Savitzky-Golay filter (<i>Savitzky & Golay</i>, 1964).\n"
            "<h4>Parameters:</h4>"
            "- <b>Max segment length</b>: Densifies sparse segments before smoothing. "
            ...
            "- <b>Window length</b>: The length of the filter window (must be odd). "
            "Larger values produce smoother results.\n"
            "- <b>Polynomial order</b>: The order of the polynomial used to fit samples. "
            ...
            "by Simplified Least Squares Procedures. Anal. Chem. 36, 1627–1639 (1964).\n"
            "Sylvester, Z., Durkin, P. R., Hubbard, S. M. & Mohrig, D. Autogenic "
